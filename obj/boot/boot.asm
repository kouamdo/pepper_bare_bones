...
call_second_boot:
    ...
    7c15:	ff 36                	pushl  (%esi)
    7c17:	50                   	push   %eax
    7c18:	7d e9                	jge    7c03 <entry+0x3>
	jmp 0x7e00
    7c1a:	e4 01                	in     $0x1,%al

00007c1c <read_sectors>:
...
00007c21 <reset_disk>:
    ...
    7c23:	cd 13                	int    $0x13
	jc reset_disk
    7c25:	72 fa                	jb     7c21 <reset_disk>
	

	mov bx , 0x7E00
    7c27:	bb 00 7e b6 04       	mov    $0x4b67e00,%ebx
    ...
    7c2d:	b4 02                	mov    $0x2,%ah
    mov al , dh         ; Read DH sectors
    7c2f:	88 f0                	mov    %dh,%al
    mov ch , 0x00       ; Select cylinder 0
    7c31:	b5 00                	mov    $0x0,%ch
    mov dh , 0x00       ; Select head 0
    7c33:	b6 00                	mov    $0x0,%dh
    mov cl , 0x02       ; Start reading from second sector ( i.e.
    7c35:	b1 02                	mov    $0x2,%cl
	...
	jc .disk_err_
    7c39:	72 06                	jb     7c41 <reset_disk.disk_err_>

	pop dx
    7c3b:	5a                   	pop    %edx

	cmp dh , al
    7c3c:	38 c6                	cmp    %al,%dh
	jne .disk_err_
    7c3e:	75 01                	jne    7c41 <reset_disk.disk_err_>
	ret
    7c40:	c3                   	ret    

00007c41 <reset_disk.disk_err_>:

.disk_err_:
		mov eax , 1
    7c41:	66 b8 01 00          	mov    $0x1,%ax
    7c45:	00 00                	add    %al,(%eax)
		mov dword[err] , eax
    7c47:	66                   	data16
    7c48:	a3                   	.byte 0xa3
    7c49:	54                   	push   %esp
    7c4a:	7d c3                	jge    7c0f <entry.1+0x9>

00007c4c <__simple_print_boot__>:
short bootdrive;
...
{
    7c4c:	66 55                	push   %bp
    7c4e:	66 89 e5             	mov    %sp,%bp
    7c51:	66 53                	push   %bx
    7c53:	66 83 ec 10          	sub    $0x10,%sp
    int i = 0;
    7c57:	67 66 c7 45 f8 00 00 	movw   $0x0,-0x8(%di)
    7c5e:	00 00                	add    %al,(%eax)

    while (msg[i] != '\0') {
    7c60:	eb 2a                	jmp    7c8c <__simple_print_boot__+0x40>
        __asm__("int $0x10" ::"a"((0x0E << 8) | msg[i]), "b"(0x07));
    7c62:	67 66 8b 55 f8       	mov    -0x8(%di),%dx
    7c67:	67 66 8b 45 08       	mov    0x8(%di),%ax
    7c6c:	66 01 d0             	add    %dx,%ax
    7c6f:	67 66 0f b6 00       	movzbw (%bx,%si),%ax
    7c74:	66 0f be c0          	movsbw %al,%ax
    7c78:	80 cc 0e             	or     $0xe,%ah
    7c7b:	66 ba 07 00          	mov    $0x7,%dx
    7c7f:	00 00                	add    %al,(%eax)
    7c81:	66 89 d3             	mov    %dx,%bx
    7c84:	cd 10                	int    $0x10
        ++i;
    7c86:	67 66 83 45 f8 01    	addw   $0x1,-0x8(%di)
    while (msg[i] != '\0') {
    7c8c:	67 66 8b 55 f8       	mov    -0x8(%di),%dx
    7c91:	67 66 8b 45 08       	mov    0x8(%di),%ax
    7c96:	66 01 d0             	add    %dx,%ax
    7c99:	67 66 0f b6 00       	movzbw (%bx,%si),%ax
    7c9e:	84 c0                	test   %al,%al
    7ca0:	75 c0                	jne    7c62 <__simple_print_boot__+0x16>
    }
}
    7ca2:	90                   	nop
    7ca3:	90                   	nop
    7ca4:	67 66 8b 5d fc       	mov    -0x4(%di),%bx
    7ca9:	66 c9                	leavew 
    7cab:	66 c3                	retw   
...
{
    7cad:	66 55                	push   %bp
    7caf:	66 89 e5             	mov    %sp,%bp
    7cb2:	66 83 ec 08          	sub    $0x8,%sp
    read_sectors();
    7cb6:	66 e8 60 ff          	callw  7c1a <call_second_boot+0x5>
    7cba:	ff                   	(bad)  
    7cbb:	ff 66 a1             	jmp    *-0x5f(%esi)

    if (err == 1)
    7cbe:	54                   	push   %esp
    7cbf:	7d 66                	jge    7d27 <main_boot+0x7a>
    7cc1:	83 f8 01             	cmp    $0x1,%eax
    7cc4:	75 16                	jne    7cdc <main_boot+0x2f>
        __simple_print_boot__("Bad boot device\n");
    7cc6:	66 83 ec 0c          	sub    $0xc,%sp
    7cca:	66 68 e4 7c          	pushw  $0x7ce4
    7cce:	00 00                	add    %al,(%eax)
    7cd0:	66 e8 76 ff          	callw  7c4a <reset_disk.disk_err_+0x9>
    7cd4:	ff                   	(bad)  
    7cd5:	ff 66 83             	jmp    *-0x7d(%esi)
    7cd8:	c4 10                	les    (%eax),%edx
    7cda:	eb 06                	jmp    7ce2 <main_boot+0x35>

    else
        call_second_boot();
    7cdc:	66 e8 33 ff          	callw  7c13 <entry.1+0xd>
    7ce0:	ff                   	(bad)  
    7ce1:	ff                   	(bad)  
end:
    goto end;
    7ce2:	eb fe                	jmp    7ce2 <main_boot+0x35>
